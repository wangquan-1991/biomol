				...
				<html>
					<head>
						...
						<title>RFdiffusion</title>
					</head>
					<body>
						<div class="exported-note"><div class="exported-note-title">RFdiffusion</div>
...
.mermaid { background-color: white; width: 640px; }</style><div id="rendered-md"><h2 id="dockerfile">dockerfile</h2>
<div class="joplin-editable"><pre class="joplin-source" data-joplin-language="dockerfile" data-joplin-source-open="```dockerfile&#10;" data-joplin-source-close="&#10;```">FROM nvidia/cuda:11.6.2-cudnn8-runtime-ubuntu20.04
...
ENTRYPOINT [&quot;jupyter-lab&quot;, &quot;--no-browser&quot;, &quot;--ip='0.0.0.0'&quot;, &quot;--allow-root&quot;]</pre><pre class="hljs"><code><span class="hljs-keyword">FROM</span> nvidia/cuda:<span class="hljs-number">11.6</span>.<span class="hljs-number">2</span>-cudnn8-runtime-ubuntu20.<span class="hljs-number">04</span>
<span class="hljs-keyword">ARG</span> DEBIAN_FRONTEND=noninteractive

<span class="hljs-keyword">RUN</span><span class="language-bash"> sed -i <span class="hljs-string">&#x27;s@//.*archive.ubuntu.com@//mirrors.ustc.edu.cn@g&#x27;</span> /etc/apt/sources.list \
  &amp;&amp; sed -i <span class="hljs-string">&#x27;s/security.ubuntu.com/mirrors.ustc.edu.cn/g&#x27;</span> /etc/apt/sources.list \
    &amp;&amp; apt-get -q update \ </span>
  &amp;&amp; DEBIAN_FRONTEND=noninteractive apt-get install --no-install-recommends -y \
  git \
  vim \
  wget \
  python3.<span class="hljs-number">9</span> \
  python3-pip \
  python-is-python3 \
  &amp;&amp; git clone https://ghproxy.com/https://github.com/RosettaCommons/RFdiffusion.git \
  &amp;&amp; mkdir ./RFdiffusion/rfdiffusion/models	\
  &amp;&amp; sed -i <span class="hljs-string">&#x27;s|https://github.com|https://ghproxy.com/https://github.com|g&#x27;</span> ./RFdiffusion/<span class="hljs-keyword">env</span>/SE3nv.yml \
  &amp;&amp; pip config set global.index-url https://pypi.tuna.tsinghua.edu.cn/simple \
  &amp;&amp; python3.<span class="hljs-number">9</span> -m pip install -q -U --no-cache-dir pip \
  &amp;&amp; rm -rf /var/lib/apt/lists/* \
  &amp;&amp; apt-get autoremove -y \
  &amp;&amp; apt-get clean \
  &amp;&amp; pip install -q --no-cache-dir \
  dgl==<span class="hljs-number">1.0</span>.<span class="hljs-number">2</span>+cu116 -f https://data.dgl.ai/wheels/cu116/repo.html \
  torch==<span class="hljs-number">1.12</span>.<span class="hljs-number">1</span>+cu116 --extra-index-url https://download.pytorch.org/whl/cu116 \
  e3nn==<span class="hljs-number">0.3</span>.<span class="hljs-number">3</span> \
  wandb==<span class="hljs-number">0.12</span>.<span class="hljs-number">0</span> \
  pynvml==<span class="hljs-number">11.0</span>.<span class="hljs-number">0</span> \
  git+https://ghproxy.com/https://github.com/NVIDIA/dllogger<span class="hljs-comment">#egg=dllogger \</span>
  decorator==<span class="hljs-number">5.1</span>.<span class="hljs-number">0</span> \
  hydra-core==<span class="hljs-number">1.3</span>.<span class="hljs-number">2</span> \
  pyrsistent==<span class="hljs-number">0.19</span>.<span class="hljs-number">3</span> \
  jupyterlab \
  ./RFdiffusion/<span class="hljs-keyword">env</span>/SE3Transformer \
  &amp;&amp; pip install --no-cache-dir ./RFdiffusion --no-deps \
  &amp;&amp; ln -s ./RFdiffusion/rfdiffusion/models /usr/local/lib/python3.<span class="hljs-number">8</span>/dist-packages/models

<span class="hljs-keyword">ENV</span> DGLBACKEND=<span class="hljs-string">&quot;pytorch&quot;</span>

<span class="hljs-keyword">ENTRYPOINT</span><span class="language-bash"> [<span class="hljs-string">&quot;jupyter-lab&quot;</span>, <span class="hljs-string">&quot;--no-browser&quot;</span>, <span class="hljs-string">&quot;--ip=&#x27;0.0.0.0&#x27;&quot;</span>, <span class="hljs-string">&quot;--allow-root&quot;</span>]</span></code></pre></div>
...
sudo docker run --name rfdiffusion-gpu --gpus all -p 9901:8888 -d rfdiffusion:latest  </pre><pre class="hljs"><code><span class="hljs-comment">## build &amp; deploy </span>

``` bash
sudo docker build -t rfdiffusion .
sudo docker <span class="hljs-built_in">run</span> <span class="hljs-comment">--name rfdiffusion-gpu --gpus all -p 9901:8888 -d rfdiffusion:latest  </span></code></pre></div>
</div></div>
					</body>
				</html>
